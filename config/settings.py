...
SECRET_KEY = 'django-insecure-3k8288j5^t&csd!ap*l+4_dl*6a3e_8bm)(!o=kt_rrs(=@+9x'
...
SPECTACULAR_SETTINGS = {
    ...
    'TITLE': 'Jeongmin Django Lab API Document',
    'DESCRIPTION': '이정민의 Django Lab API 명세서입니다.',
    # Optional: MAY contain "name", "url", "email"
    'CONTACT': {'name': '이정민', 'url': 'https://www.jeongmingz.life/', 'email': 'joungminyt@gmail.com'},
